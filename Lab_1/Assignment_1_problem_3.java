...
public class Assignment_1_problem_3 {
    ...
    public static void displayAllStudents() {
        ...
        for (int i = 0; i < size; i++) {
            System.out.println("---------------------");
            display(students[i].name, students[i].rollNumber, students[i].department,
    ...
    public static void display(String name, int rollNumber, String department, double averageMarks) {
